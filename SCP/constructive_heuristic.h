...
/*
	When columns are added to the solution, this will scan the instance matrix and check which rows it is covering.  Will keep track of this info in the number_of_columns_covering_row array.
*/
